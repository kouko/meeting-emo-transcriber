...
func writeConfigTemplate(configPath string, sc SaveableConfig) error {
	...
	lines = append(lines, "# -------------------------------------------------------")
	lines = append(lines, "")
	lines = append(lines, "# ASR language")
	...
	lines = append(lines, "")
	lines = append(lines, "# Diarization clustering threshold")
	...
	lines = append(lines, "")
	lines = append(lines, "# Speaker matching threshold (cosine similarity)")
	...
	lines = append(lines, "")
	lines = append(lines, "# Custom vocabulary / context hints for ASR")
